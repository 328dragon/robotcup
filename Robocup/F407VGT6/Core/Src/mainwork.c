...
Color_t *current_color_ptr = &current_color_HSL;
int color_task_lock = 0;
...
void usart1_callback(void)
{
    if (uart1.recv_buff[0] == 0x91 && uart1.recv_buff[1] == 0xCB)
    {
        ...
        if(qr_code != 0 && color_task_lock == 0)
        {
            color_task_lock++;
            GetColorTask(color_task, qr_code_ptr);
        }
        if(qr_code != 0 && rank_task_lock == 0)
        {
            rank_task_lock++;
...
void main_work(void)
{
    ...
    Kinematic_init(kinematic_ptr, 0.2, 1.1, X_shape);
    ...
    BaseType_t ok2 = xTaskCreate(OnChassicControl, "Chassic_control", 400, NULL, 3, &Chassic_control_handle);
    BaseType_t ok3 = xTaskCreate(Onmaincpp, "main_cpp", 500, NULL, 4, &main_cpp_handle);
    ...
    while (1)
    {
        ...
        if (safe_count >= 3)
        {
            ...
            case 6:
            {
                ...
                {
                    vTaskDelay(500);
                    move_step_distance(0.1, 0.02, 0, 1);
                    main_state++;
                }
                break;
            }
            ...
            case 9:
            {
                ...
                {
                    vTaskDelay(1000);
                    move_step_distance(0.07, -0.42, 0, 1);
                    main_state++;
                }
                break;
            }
            ...
            case 12:
            {
                ...
                {
                    vTaskDelay(1000);
                    move_step_distance(-0.10, -0.50, 0, 1);
                    main_state++;
                }
                break;
            }
            ...
            if (main_state > 22)
            {
                ...
                /////////////等待空闲去找CCCCCCCCCCCCCCCCCCCCCCCC///////
                case 15:
                {
                ...
                case 20:
                {
                    ...
                    {
                        vTaskDelay(200);
                        move_step_distance(0.26, 0.19, 0, 1);
                        main_put_state++;
                    }
                    break;
                }
           ...
           case 0:
            ...
            case 1:
            {
                if (SimpleStatus_t_isResolved(&planner_ptr->promise))
                {
                    ...
                    setYawZero();
                    vTaskDelay(500);
                    move_step_distance(0.6, 0.39, 0, 1);
                    main_second_state++;
                }
                break;
            }
            ...
            case 9:
            {
                ...
                {
                    vTaskDelay(1000);
                    move_step_distance(-0.3, 0.44, 0, 1);
                    main_second_state++;
                }
                break;
            }
            ...
            case 25:
            {
                if (*upperflag_ptr == IDLE)
                {
                    ...
                    main_second_state++;
                    vTaskDelay(500);
                    move_step_distance(-1.9, -0.33, 0, 1);
                }
                break;
            }
